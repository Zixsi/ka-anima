...
<head>
	...
	<link rel="stylesheet" href="<?=TEMPLATE_DIR?>/admin_1/assets/vendor/chartist/css/chartist-custom.css">
	<!-- MAIN CSS -->
...
<body>
	...
	<div id="wrapper">
		...
		<nav class="navbar navbar-default navbar-fixed-top">
			<div class="brand">
				<a href="index.html"><img src="<?=TEMPLATE_DIR?>/admin_1/assets/img/logo-dark.png" alt="Klorofil Logo" class="img-responsive logo"></a>
			</div>
			...
			<div class="sidebar-scroll">
				<nav>
					<ul class="nav">
						...
						<li><a href="#l" class=""><i class="lnr lnr-dice"></i> <span>Tables</span></a></li>
							...
							<div class="panel panel-scrolling">
								...
								<div class="panel-body">
									<ul class="list-unstyled activity-list">
										<li>
											<img src="<?=TEMPLATE_DIR?>/admin_1/assets/img/user1.png" alt="Avatar" class="img-circle pull-left avatar">
											<p><a href="#">Michael</a> has achieved 80% of his completed tasks <span class="timestamp">20 minutes ago</span></p>
										</li>
										<li>
											<img src="<?=TEMPLATE_DIR?>/admin_1/assets/img/user2.png" alt="Avatar" class="img-circle pull-left avatar">
											<p><a href="#">Daniel</a> has been added as a team member to project <a href="#">System Update</a> <span class="timestamp">Yesterday</span></p>
										</li>
										<li>
											<img src="<?=TEMPLATE_DIR?>/admin_1/assets/img/user3.png" alt="Avatar" class="img-circle pull-left avatar">
											<p><a href="#">Martha</a> created a new heatmap view <a href="#">Landing Page</a> <span class="timestamp">2 days ago</span></p>
										</li>
										<li>
											<img src="<?=TEMPLATE_DIR?>/admin_1/assets/img/user4.png" alt="Avatar" class="img-circle pull-left avatar">
											<p><a href="#">Jane</a> has completed all of the tasks <span class="timestamp">2 days ago</span></p>
										</li>
										<li>
											<img src="<?=TEMPLATE_DIR?>/admin_1/assets/img/user5.png" alt="Avatar" class="img-circle pull-left avatar">
	...
	<script src="<?=TEMPLATE_DIR?>/admin_1/assets/vendor/jquery.easy-pie-chart/jquery.easypiechart.min.js"></script>
	<script src="<?=TEMPLATE_DIR?>/admin_1/assets/vendor/chartist/js/chartist.min.js"></script>
