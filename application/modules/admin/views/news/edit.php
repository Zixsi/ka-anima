		...
		<div class="col-xs-12">
			...
			<form action="./" method="POST" enctype="multipart/form-data">
				...
				<div class="form-group">
					...
					<input type="text" name="title" id="ftitle" class="form-control" value="<?=set_value('title', $item['title'], true)?>">
				</div>
				<div class="form-group">
					<label for="ftext">Описание</label>
					<textarea name="text" id="ftext" class="form-control" rows="10"><?=set_value('text', $item['text'], true)?></textarea>
				</div>
				<div class="form-group">
