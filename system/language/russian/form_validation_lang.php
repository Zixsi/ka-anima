...
$lang['form_validation_valid_email']		= 'Поле {field} должно содержать валидный email адрес';
$lang['form_validation_valid_emails']		= 'Поле {field} должно содержать все валидные email адреса';
$lang['form_validation_valid_url']		= 'Поле {field} должно содержать валидный URL';
$lang['form_validation_valid_ip']		= 'Поле {field} должно содержать валидный IP';
$lang['form_validation_min_length']		= 'Поле {field} должно быть длинойне менее {param} символов';
...
$lang['form_validation_regex_match']		= 'Поле {field} имеет неверный формат';
...
$lang['form_validation_is_natural']		= 'Поле {field} должно содержать только натуральное число';
$lang['form_validation_is_natural_no_zero']	= 'Поле {field} должно содержать только натуральное число и должно быть больше нуля';
...
$lang['form_validation_in_list']		= 'Значение поля {field} должно быть одним из: {param}';
